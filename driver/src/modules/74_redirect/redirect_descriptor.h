// MyArk redirect module: descriptor + IOCTL handler prototypes.
...
NTSTATUS MyArkRedirectInit(VOID);
VOID     MyArkRedirectCleanup(VOID);
...
extern MYARK_MODULE_DESCRIPTOR g_MyArkModule_Redirect;
