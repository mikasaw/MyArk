...
// driver_entry loader the descriptor with one pointer to follow. The actual
// IOCTL implementations live in process_ioctl.c.
...
//
// IOCTL handlers -- the names match those declared in process_internal.h
// and implemented in process_ioctl.c.
//
